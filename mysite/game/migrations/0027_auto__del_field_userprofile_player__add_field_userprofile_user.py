...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.player'
        db.delete_column('game_userprofile', 'player_id')

        # Adding field 'UserProfile.user'
        db.add_column('game_userprofile', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['auth.User'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.player'
        db.add_column('game_userprofile', 'player',
        ...
        db.delete_column('game_userprofile', 'user_id')
    ...
    models = {
        ...
        'game.patientstate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.Patient']"}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.UserProfile']"}),
