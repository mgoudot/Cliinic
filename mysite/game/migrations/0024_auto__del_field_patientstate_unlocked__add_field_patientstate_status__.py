...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PatientState.unlocked'
        db.delete_column('game_patientstate', 'unlocked')

        # Adding field 'PatientState.status'
        db.add_column('game_patientstate', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Changing field 'PatientState.player'
        db.alter_column('game_patientstate', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.PlayerProfile']))
        # Deleting field 'PlayerProfile.patient'
        db.delete_column('game_playerprofile', 'patient_id')

        # Deleting field 'PlayerProfile.patientTreated'
        db.delete_column('game_playerprofile', 'patientTreated')


    def backwards(self, orm):
        # Adding field 'PatientState.unlocked'
        db.add_column('game_patientstate', 'unlocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PatientState.status'
        db.delete_column('game_patientstate', 'status')


        # Changing field 'PatientState.player'
        db.alter_column('game_patientstate', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Adding field 'PlayerProfile.patient'
        db.add_column('game_playerprofile', 'patient',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Patient'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlayerProfile.patientTreated'
        db.add_column('game_playerprofile', 'patientTreated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        'game.patientstate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.Patient']"}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.PlayerProfile']"}),
