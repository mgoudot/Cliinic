...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TreatState.name'
        db.delete_column('game_treatstate', 'name_id')

        # Deleting field 'InvestigateState.name'
        db.delete_column('game_investigatestate', 'name_id')


    def backwards(self, orm):
        # Adding field 'TreatState.name'
        db.add_column('game_treatstate', 'name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['game.Treatment']),
                      keep_default=False)

        # Adding field 'InvestigateState.name'
        db.add_column('game_investigatestate', 'name',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['game.Investigation']),
                      keep_default=False)
