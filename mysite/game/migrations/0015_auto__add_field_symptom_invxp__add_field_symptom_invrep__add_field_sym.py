...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Symptom.invxp'
        db.add_column('game_symptom', 'invxp',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Symptom.invrep'
        db.add_column('game_symptom', 'invrep',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Symptom.treatxp'
        db.add_column('game_symptom', 'treatxp',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Symptom.treatrep'
        db.add_column('game_symptom', 'treatrep',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Symptom.invxp'
        db.delete_column('game_symptom', 'invxp')

        # Deleting field 'Symptom.invrep'
        db.delete_column('game_symptom', 'invrep')

        # Deleting field 'Symptom.treatxp'
        db.delete_column('game_symptom', 'treatxp')

        # Deleting field 'Symptom.treatrep'
        db.delete_column('game_symptom', 'treatrep')
