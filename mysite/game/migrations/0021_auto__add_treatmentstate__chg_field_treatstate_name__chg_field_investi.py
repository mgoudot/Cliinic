...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('game_treatmentstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('treatment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Treatment'])),
        ...
        db.send_create_signal('game', ['TreatmentState'])


        # Changing field 'TreatState.name'
        db.alter_column('game_treatstate', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.TreatmentState']))

        # Changing field 'InvestigateState.name'
        db.alter_column('game_investigatestate', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.InvestigationState']))

    def backwards(self, orm):
        # Deleting model 'TreatmentState'
        db.delete_table('game_treatmentstate')


        # Changing field 'TreatState.name'
        db.alter_column('game_treatstate', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Treat']))

        # Changing field 'InvestigateState.name'
        db.alter_column('game_investigatestate', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Investigation']))
