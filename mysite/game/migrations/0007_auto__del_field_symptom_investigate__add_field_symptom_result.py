...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Symptom.investigate'
        db.delete_column('game_symptom', 'investigate_id')
    ...
    def backwards(self, orm):
        # Adding field 'Symptom.investigate'
        db.add_column('game_symptom', 'investigate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Patient'], null=True),
                      keep_default=False)
