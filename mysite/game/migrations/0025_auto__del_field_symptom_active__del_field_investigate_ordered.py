...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Symptom.active'
        db.delete_column('game_symptom', 'active')

        # Deleting field 'Investigate.ordered'
        db.delete_column('game_investigate', 'ordered')


    def backwards(self, orm):
        # Adding field 'Symptom.active'
        db.add_column('game_symptom', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Investigate.ordered'
        db.add_column('game_investigate', 'ordered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
