...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InvestigationState'
        db.create_table('game_investigationstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('investigation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Investigation'])),
        ...
        db.send_create_signal('game', ['InvestigationState'])


    def backwards(self, orm):
        # Deleting model 'InvestigationState'
        db.delete_table('game_investigationstate')
