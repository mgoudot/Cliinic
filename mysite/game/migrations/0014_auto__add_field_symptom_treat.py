...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Symptom.treat'
        db.add_column('game_symptom', 'treat',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['game.Treat'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Symptom.treat'
        db.delete_column('game_symptom', 'treat_id')
