...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('game_symptom', 'investigate',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['game.Investigate']),
                      keep_default=False)
    ...
    models = {
        ...
        'game.symptom': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigate': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['game.Investigate']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
