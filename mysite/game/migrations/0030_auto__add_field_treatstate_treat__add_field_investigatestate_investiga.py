...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreatState.treat'
        db.add_column('game_treatstate', 'treat',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['game.Treat'], null=True),
                      keep_default=False)

        # Adding field 'InvestigateState.investigate'
        db.add_column('game_investigatestate', 'investigate',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['game.Investigate'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreatState.treat'
        db.delete_column('game_treatstate', 'treat_id')

        # Deleting field 'InvestigateState.investigate'
        db.delete_column('game_investigatestate', 'investigate_id')
    ...
    models = {
        ...
        'game.investigatestate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigate': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['game.Investigate']", 'null': 'True'}),
        ...
        'game.treatstate': {
            ...
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.PatientState']"}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'treat': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['game.Treat']", 'null': 'True'})
        },
        'game.userprofile': {
