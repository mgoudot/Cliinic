...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SymptomState', fields ['player']
        db.delete_unique('game_symptomstate', ['player_id'])

        # Removing unique constraint on 'PatientState', fields ['player']
        db.delete_unique('game_patientstate', ['player_id'])
        ...
        # Changing field 'SymptomState.player'
        db.alter_column('game_symptomstate', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'PatientState.player'
        db.alter_column('game_patientstate', 'player_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'PatientState', fields ['player']
        db.create_unique('game_patientstate', ['player_id'])


        # Changing field 'SymptomState.player'
        db.alter_column('game_symptomstate', 'player_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'SymptomState', fields ['player']
        db.create_unique('game_symptomstate', ['player_id'])
