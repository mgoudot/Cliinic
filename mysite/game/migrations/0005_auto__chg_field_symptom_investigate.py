...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('game_symptom', 'investigate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Patient'], null=True))

    def backwards(self, orm):

        # Changing field 'Symptom.investigate'
        db.alter_column('game_symptom', 'investigate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Investigate']))
    ...
    models = {
        ...
        'game.symptom': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.Patient']", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
