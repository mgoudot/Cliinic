...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Symptom.patient'
        db.add_column('game_symptom', 'patient',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='none', to=orm['game.Patient']),
                      keep_default=False)

        # Adding field 'Symptom.result'
        db.add_column('game_symptom', 'result',
                      self.gf('django.db.models.fields.CharField')(default='negative', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Symptom.patient'
        db.delete_column('game_symptom', 'patient_id')

        # Deleting field 'Symptom.result'
        db.delete_column('game_symptom', 'result')
    ...
    models = {
        ...
        'game.symptom': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'to': "orm['game.Patient']"}),
