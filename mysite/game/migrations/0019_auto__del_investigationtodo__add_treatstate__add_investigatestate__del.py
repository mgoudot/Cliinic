...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TreatState'
        db.create_table('game_treatstate', (
            ...
            ('name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Treat'])),
            ('ordered', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('game', ['TreatState'])

        # Adding model 'InvestigateState'
        db.create_table('game_investigatestate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.PatientState'])),
        ...
        db.send_create_signal('game', ['InvestigateState'])

        # Deleting field 'Treat.ordered'
        db.delete_column('game_treat', 'ordered')
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TreatState'
        db.delete_table('game_treatstate')

        # Deleting model 'InvestigateState'
        db.delete_table('game_investigatestate')

        # Adding field 'Treat.ordered'
        db.add_column('game_treat', 'ordered',
    ...
    models = {
        ...
        'game.treatstate': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.Treat']"}),
            'ordered': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.PatientState']"}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
