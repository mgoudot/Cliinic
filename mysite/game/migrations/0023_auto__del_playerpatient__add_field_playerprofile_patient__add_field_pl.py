...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PlayerPatient'
        db.delete_table('game_playerpatient')
    ...
    def backwards(self, orm):
        # Adding model 'PlayerPatient'
        db.create_table('game_playerpatient', (
        ...
        db.send_create_signal('game', ['PlayerPatient'])
    ...
    models = {
        ...
        'game.playerprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['game.Patient']", 'null': 'True', 'blank': 'True'}),
