...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('game_treatmenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('game', ['TreatmentType'])

        # Adding model 'Treat'
        db.create_table('game_treat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Treatment'])),
        ...
        db.send_create_signal('game', ['Treat'])

        # Adding model 'Treatment'
        db.create_table('game_treatment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('treattype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.TreatmentType'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('game', ['Treatment'])


    def backwards(self, orm):
        # Deleting model 'TreatmentType'
        db.delete_table('game_treatmenttype')

        # Deleting model 'Treat'
        db.delete_table('game_treat')

        # Deleting model 'Treatment'
        db.delete_table('game_treatment')
